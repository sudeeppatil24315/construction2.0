            ...
            {project.images.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center bg-black/50 hover:bg-gold text-white rounded-full transition-colors"
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center bg-black/50 hover:bg-gold text-white rounded-full transition-colors"
