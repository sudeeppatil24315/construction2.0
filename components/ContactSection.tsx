          ...
          >
            ...
            <div className="space-y-4 mb-8">
              {contactInfo.map((info, index) => (
                <div
                  key={index}
                  className="bg-gray-900 p-6 rounded-lg border border-gray-800 hover:border-gold transition-all duration-300 group"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-sm font-semibold text-gray-400 mb-1">{info.title}</h4>
                      {info.link ? (
                        <a
                          href={info.link}
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black p-6 rounded-lg border border-gray-800">
              <h4 className="text-xl font-bold mb-4 text-gold">Business Hours</h4>
